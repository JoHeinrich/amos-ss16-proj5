...
echo "This script will start our docker container for the caf and protobuf communication demo. Please give the name of a docker network and the tag for the docker image you want to start the client."
echo -en '\n'
if [ $# -lt 2 ]; then 
  echo -en '\n'
